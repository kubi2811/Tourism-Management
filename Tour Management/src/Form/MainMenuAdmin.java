...
public class MainMenuAdmin extends javax.swing.JFrame {
    ...
    public MainMenuAdmin() {
        initComponents();
        MainMenuAdmin.this.getRootPane().setBorder(new LineBorder(new Color(102, 102, 255)));
        ...
        sidepaneLayout.setHorizontalGroup(
            ...
            .addGroup(sidepaneLayout.createSequentialGroup()
                .addGroup(sidepaneLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(sidepaneLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(label_forAdmin, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)))
...
//        pnlRight.add(CAT).setVisible(true);
    ...
    private void lblMaximizeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMaximizeMousePressed
        if (MainMenuAdmin.this.getExtendedState() == MAXIMIZED_BOTH) {
            MainMenuAdmin.this.setExtendedState(JFrame.NORMAL);
        } else {
            MainMenuAdmin.this.setExtendedState(MAXIMIZED_BOTH);
        }
    ...
    private void lblMinimizeMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblMinimizeMousePressed
        MainMenuAdmin.this.setState(Frame.ICONIFIED);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        // TODO add your handling code here:
        label_forAdmin.setText("For Admin: " + Login.usernameAdmin);
